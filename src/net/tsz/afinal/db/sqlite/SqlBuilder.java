...
public class SqlBuilder {
	...
	public static String getSelectCountSQL(Class<?> clazz){
		...
		StringBuffer strSQL = new StringBuffer(getSelectCountSqlByTableName(table.getTableName()));
		
		return strSQL.toString();
	}
	
	public static String getSelectCountSQLByWhere(Class<?> clazz,String strWhere){
		TableInfo table=TableInfo.get(clazz);
