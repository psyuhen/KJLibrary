...
public class KJListViewFooter extends LinearLayout {
    ...
    public void setState(LoadMoreState state) {
        ...
        if (state == LoadMoreState.STATE_READY) {
            hintView.setText(getResources().getString(R.string.pull_to_refresh_from_bottom_release_label));
        } else if (state == LoadMoreState.STATE_LOADING) {
            progressBar.setVisibility(View.VISIBLE);
            hintView.setText(getResources().getString(R.string.pull_to_refresh_from_bottom_refreshing_label));
        } else {
            hintView.setText(getResources().getString(R.string.pull_to_refresh_from_bottom_pull_label));
        }
    }
