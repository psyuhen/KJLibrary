...
public class KJListViewHeader extends LinearLayout {
    ...
    public void setState(RefreshState state) {
        ...
        case STATE_NORMAL:
            ...
            hintTextView.setText(getResources().getString(R.string.pull_to_refresh_pull_label));
            break;
        case STATE_READY:
            if (mState != RefreshState.STATE_READY) {
                arrowImageView.clearAnimation();
                arrowImageView.startAnimation(rotateUpAnim);
                hintTextView.setText(getResources().getString(R.string.pull_to_refresh_release_label));
            }
            break;
        case STATE_REFRESHING:
            hintTextView.setText(getResources().getString(R.string.pull_to_refresh_refreshing_label));
            break;
        default:
        }
        mState = state;
